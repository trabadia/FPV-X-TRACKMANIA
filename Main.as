...
const int LS_EXPORT_STEP5  = 84;
const int LS_EXPORT_TIP    = 85;
const int LS_LOC_COUNT     = 86;
...
g_Str[LS_INV_ROLL]      = "Inverser Roll (stick D. X)";
    ...
    g_Str[LS_EXPORT_STEP1]  = "Pour exporter une trajectoire en CLIP afin de la visualiser et la rendre dans Mediatracker :";
    g_Str[LS_EXPORT_STEP2]  = "1. Après l'enregistrement, clique sur le bouton .csv dans le HUD, trouvable ici";
    g_Str[LS_EXPORT_STEP3]  = "\\$888Astuce n°2 : la trajectoire enregistrée est dans C:\\Users\\name\\OpenplanetNext\\PluginStorage\\FPVDrone\\trajectory.csv";
    g_Str[LS_EXPORT_BTN]    = "Ouvrir le dossier";
    g_Str[LS_EXPORT_LINK]   = "2. Transférer votre fichier .csv";
    g_Str[LS_EXPORT_STEP4]  = "3. Déplacez le fichier .clip téléchargé dans votre dossier Replay";
    g_Str[LS_EXPORT_STEP5]  = "4. Aller dans le menu Création, éditeur de replay, choisissez un replay existant sur la map où vous souhaitez ajouter votre caméra drone. Cliquez sur \"Importer un clip\" en bas.";
    g_Str[LS_EXPORT_TIP]    = "\\$888Astuce n°1 : si vous souhaitez modifier les clés du bloc de caméra, il est conseillé de record à 1 ou 2 frames par seconde afin de ne pas avoir des centaines de clés à modifier manuellement. Utile si vous souhaitez cibler un replay par exemple.";
    ...
    if (g_Lang == 1) { // ── English ──────────────────────────
        ...
        g_Str[LS_HELP_REC]      = "Recording: short press on Record bind starts and stops recording. During recording, holding the Rewind bind makes the drone go back in time. Inputs can be kept active during rewind to smoothly resume the trajectory when released.";
...
g_Str[LS_REWIND]        = "Rewind";
        g_Str[LS_EXPORT_SECT]   = "\\$888--- Export Mediatracker CLIP ---";
        g_Str[LS_EXPORT_STEP1]  = "To export a trajectory as CLIP for viewing and rendering in Mediatracker:";
        g_Str[LS_EXPORT_STEP2]  = "1. After recording, click the .csv button in the HUD, found here";
        g_Str[LS_EXPORT_STEP3]  = "\\$888Tip 2: the recorded trajectory is at: C:\\Users\\name\\OpenplanetNext\\PluginStorage\\FPVDrone\\trajectory.csv";
        g_Str[LS_EXPORT_BTN]    = "Open folder";
        g_Str[LS_EXPORT_LINK]   = "2. Upload your .csv file";
        g_Str[LS_EXPORT_STEP4]  = "3. Move the downloaded .clip file to your Replay folder";
        g_Str[LS_EXPORT_STEP5]  = "4. Go to the Creation menu, replay editor, choose an existing replay on the map where you want to add your drone camera. Click \"Import a clip\" at the bottom.";
        g_Str[LS_EXPORT_TIP]    = "\\$888Tip 1: if you want to edit the camera block keys, it is recommended to record at 1 or 2 frames per second to avoid having hundreds of keys to edit manually. Useful if you want to target a specific replay for example.";
        ...
        g_Str[LS_HELP_REC]      = "Aufnahme: Ein kurzer Druck auf den Record-Bind startet und stoppt die Aufnahme. Während der Aufnahme hältst du den Rewind-Bind gedrückt, um in der Zeit zurückzugehen. Die Inputs können während des Rewinds aktiv gehalten werden, um beim Loslassen nahtlos fortzufahren.";
...
g_Str[LS_INV_ROLL]      = "Rollen umkehren (rechter Stick X)";
        ...
        g_Str[LS_REWIND]        = "Rewind";
        g_Str[LS_EXPORT_SECT]   = "\\$888--- Export Mediatracker CLIP ---";
        g_Str[LS_EXPORT_STEP1]  = "Um eine Trajektorie als CLIP zum Ansehen und Rendern in Mediatracker zu exportieren:";
        g_Str[LS_EXPORT_STEP2]  = "1. Nach der Aufnahme klicke auf den .csv-Knopf im HUD, hier zu finden";
        g_Str[LS_EXPORT_STEP3]  = "\\$888Tipp 2: Die aufgezeichnete Trajektorie befindet sich unter: C:\\Users\\name\\OpenplanetNext\\PluginStorage\\FPVDrone\\trajectory.csv";
        g_Str[LS_EXPORT_BTN]    = "Ordner öffnen";
        g_Str[LS_EXPORT_LINK]   = "2. Lade deine .csv-Datei hoch";
        g_Str[LS_EXPORT_STEP4]  = "3. Verschiebe die heruntergeladene .clip-Datei in deinen Replay-Ordner";
        g_Str[LS_EXPORT_STEP5]  = "4. Gehe zum Erstellungsmenü, Replay-Editor, wähle ein vorhandenes Replay auf der Karte, zu der du deine Drohnenkamera hinzufügen möchtest. Klicke unten auf \"Clip importieren\".";
        g_Str[LS_EXPORT_TIP]    = "\\$888Tipp 1: Wenn du die Schlüssel des Kamerablocks bearbeiten möchtest, wird empfohlen, mit 1 oder 2 FPS aufzunehmen, um nicht Hunderte von Schlüsseln manuell bearbeiten zu müssen. Nützlich, wenn du ein bestimmtes Replay anvisieren möchtest.";
        ...
        g_Str[LS_HELP_REC]      = "Grabación: Una pulsación corta en Record inicia y detiene la grabación. Durante la grabación, mantener Rewind hace que el dron vuelva atrás en el tiempo. Los inputs pueden mantenerse activos durante el rewind para reanudar la trayectoria suavemente al soltar.";
...
g_Str[LS_REWIND]        = "Rewind";
        g_Str[LS_EXPORT_SECT]   = "\\$888--- Export Mediatracker CLIP ---";
        g_Str[LS_EXPORT_STEP1]  = "Para exportar una trayectoria como CLIP para visualizar y renderizar en Mediatracker:";
        g_Str[LS_EXPORT_STEP2]  = "1. Después de la grabación, haz clic en el botón .csv en el HUD, disponible aquí";
        g_Str[LS_EXPORT_STEP3]  = "\\$888Consejo 2: la trayectoria grabada está en: C:\\Users\\name\\OpenplanetNext\\PluginStorage\\FPVDrone\\trajectory.csv";
        g_Str[LS_EXPORT_BTN]    = "Abrir carpeta";
        g_Str[LS_EXPORT_LINK]   = "2. Sube tu archivo .csv";
        g_Str[LS_EXPORT_STEP4]  = "3. Mueve el archivo .clip descargado a tu carpeta Replay";
        g_Str[LS_EXPORT_STEP5]  = "4. Ve al menú de Creación, editor de replay, elige un replay existente en el mapa donde quieras añadir tu cámara drone. Haz clic en \"Importar un clip\" abajo.";
        g_Str[LS_EXPORT_TIP]    = "\\$888Consejo 1: si deseas modificar las claves del bloque de cámara, se recomienda grabar a 1 o 2 fotogramas por segundo para no tener cientos de claves que modificar manualmente. Útil si deseas apuntar a un replay concreto.";
        ...
        g_Str[LS_HELP_REC]      = "Запись: Короткое нажатие на кнопку Record начинает и останавливает запись. Во время записи удержание кнопки Rewind возвращает дрон назад во времени. Стики можно удерживать активными во время перемотки, чтобы плавно продолжить полет при отпускании.";
...
g_Str[LS_INV_VIS_ROLL]  = "Инвертировать ВИЗУАЛЬНЫЙ крен";
        ...
        g_Str[LS_EXPORT_STEP2]  = "1. После записи, кликните на кнопку .csv в HUD, найдёте её здесь";
        g_Str[LS_EXPORT_STEP3]  = "\\$888Подсказка 2: записанная траектория находится по пути: C:\\Users\\name\\OpenplanetNext\\PluginStorage\\FPVDrone\\trajectory.csv";
        g_Str[LS_EXPORT_BTN]    = "Открыть папку";
        g_Str[LS_EXPORT_LINK]   = "2. Загрузите ваш файл .csv";
        g_Str[LS_EXPORT_STEP4]  = "3. Переместите скачанный файл .clip в папку Replay";
        g_Str[LS_EXPORT_STEP5]  = "4. Перейдите в меню Создание, редактор реплея, выберите существующий реплей на карте, куда хотите добавить камеру дрона. Нажмите \"Импортировать клип\" внизу.";
        g_Str[LS_EXPORT_TIP]    = "\\$888Подсказка 1: если вы хотите редактировать ключи блока камеры, рекомендуется записывать 1 или 2 кадра в секунду, чтобы не редактировать вручную сотни ключей. Полезно, если хотите нацелиться на конкретный реплей.";
        ...
        g_Str[LS_HELP_REC]      = "Nagrywanie: Krótkie naciśnięcie przypisanego przycisku Record uruchamia i zatrzymuje nagrywanie. Podczas nagrywania przytrzymanie przycisku Rewind sprawia, że dron cofa się w czasie. Wejścia można trzymać aktywne podczas przewijania, aby płynnie wznowić lot po zwolnieniu.";
...
g_Str[LS_STATUS_ON]     = "aktywny";
        ...
        g_Str[LS_EXPORT_STEP2]  = "1. Po nagraniu kliknij przycisk .csv w HUD, dostępny tutaj";
        g_Str[LS_EXPORT_STEP3]  = "\\$888Wskazówka 2: nagrana trajektoria znajduje się w: C:\\Users\\name\\OpenplanetNext\\PluginStorage\\FPVDrone\\trajectory.csv";
        g_Str[LS_EXPORT_BTN]    = "Otwórz folder";
        g_Str[LS_EXPORT_LINK]   = "2. Prześlij swój plik .csv";
        g_Str[LS_EXPORT_STEP4]  = "3. Przenieś pobrany plik .clip do folderu Replay";
        g_Str[LS_EXPORT_STEP5]  = "4. Przejdź do menu Tworzenie, edytor powtórek, wybierz istniejącą powtórkę na mapie, do której chcesz dodać kamerę drona. Kliknij \"Importuj klip\" na dole.";
        g_Str[LS_EXPORT_TIP]    = "\\$888Wskazówka 1: jeśli chcesz edytować klucze bloku kamery, zaleca się nagrywanie z 1 lub 2 klatkami na sekundę, aby nie musieć ręcznie edytować setek kluczy. Przydatne, jeśli chcesz nakierować na konkretną powtórkę.";
    }
}
...
void RenderSettings() {
    UI::BeginTabBar("##fpvtabs");
    {
        ...
        if (UI::BeginTabItem(T(LS_HELP_TAB))) {
            ...
            UI::Text("");
            UI::TextWrapped(T(LS_HELP_WHAT) + " " + T(LS_HELP_REQ));
            UI::Text("");
            ...
            UI::TextWrapped(T(LS_EXPORT_STEP4));
            UI::TextWrapped(T(LS_EXPORT_STEP5));
            UI::Text("");
            UI::TextWrapped(T(LS_EXPORT_TIP));
            UI::Text("");
